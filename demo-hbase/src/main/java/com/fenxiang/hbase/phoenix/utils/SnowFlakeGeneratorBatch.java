...
public class SnowFlakeGeneratorBatch {
    ...
    private final long MODIFY_STAMP;
    ...
    public SnowFlakeGeneratorBatch(long startStamp, long modifyStamp, long datacenterId, long machineId){
        this.START_STMP = startStamp;
        this.datacenterId = datacenterId;
        this.machineId = machineId;
        this.MODIFY_STAMP = modifyStamp;
    }
    /**
     * 产生下一个ID
     *
...
//        System.out.println(currStmp);
    ...
    private long getNewstmp() {
        ...
        if(this.gap == -1){
            this.gap = currentTimeMillis - this.MODIFY_STAMP;
        }
        return currentTimeMillis - gap;
    }
}
