...
import com.fenxiang.hbase.mapred.hadoop.reduce.SearchReduceWithHbase;
 ...
 */
@Slf4j
public class SearchLogWithHbaseTask {
...
//        configuration.set("mapred.reduce.child.java.opts", "-Xmx1g");
        ...
        //设置job的处理类
        job.setJarByClass(SearchLogWithHbaseTask.class);
        //设置作业处理的输入路径
...
//        FileOutputFormat.setOutputPath(job, new Path(args[2]));
        ...
        // Hbase 提供的工具类进行输出
        TableMapReduceUtil.initTableReducerJob("MY_SCHEMA.SEARCH_KEYWORD", SearchReduceWithHbase.class, job);
